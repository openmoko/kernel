...
#undef GTA02_GPIO_HP_IN
#undef GTA02_GPIO_AMP_SHUT
#define GTA02_GPIO_HP_IN 0
#define GTA02_GPIO_AMP_SHUT 0
...
static int neo1973_wm8753_init(struct snd_soc_pcm_runtime *rtd)
{
	...
	snd_soc_dapm_new_controls(dapm, machine_widgets, num_machine_widgets);
	...
	/* set up neo1973 specific audio path audio_map */
	snd_soc_dapm_add_routes(dapm, audio_map, ARRAY_SIZE(audio_map));

	if (machine_is_neo1973_gta02()) {
		snd_soc_dapm_add_routes(dapm, audio_map_gta02,
